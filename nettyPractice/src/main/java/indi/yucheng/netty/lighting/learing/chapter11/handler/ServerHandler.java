...
import indi.yucheng.netty.lighting.learing.chapter11.data.MessageRequestPacket;
import indi.yucheng.netty.lighting.learing.chapter11.data.MessageResponsePacket;
...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        if (packet instanceof LoginRequestPacket) {
             ...
             *             }
             */
            handleLoginResponse(ctx, loginRequestPacket);
        } else if (packet instanceof MessageRequestPacket) {
            // 消息请求
            handleMessageResponse(ctx, packet);
            /**
    ...
    private void handleMessageResponse(ChannelHandlerContext ctx, Packet packet) {
        MessageRequestPacket messageRequestPacket = (MessageRequestPacket) packet;
        System.out.println(new Date() + " : 收到客户端消息： " + messageRequestPacket.getMessage());
    ...
    private void handleLoginResponse(ChannelHandlerContext ctx , LoginRequestPacket packet) {
